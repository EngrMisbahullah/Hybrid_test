...
export const useAuthStore = defineStore("auth", () => {
    ...
    const setLastClickedUrl = (url) => {
        ...
        console.log('Set the url :: ',redirectUrl.value);
      };

      const getLastClickedUrl = () => {
        console.log('Get the redirect Url :: ', redirectUrl.value);
        return redirectUrl.value;
    };

    const clearLastClickedUrl = () => {
          console.log('Clear the Redirect Url :: ',redirectUrl.value);
